<div class="modal fade novo-subitem" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-body">
        <form action="{{route('modulos.itens.subitens.store', [$item->modulo->id, $item->id])}}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-9">
