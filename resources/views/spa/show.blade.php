...
@section('page-title', 'Empreendimento')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="callout callout-info">
                            ...
                            <b>Telefone: </b> {!!($usuario->telefone) ? '<span class="text-primary">' . $usuario->telefone . '</span>' : '<span class="text-danger">Não definido</span>'!!}<br>
                            {{-- <b>Usuário autoriza pelo setor de engenharia ?: </b>
                                @if ($user->pessoa->engenharia == 1)
                                    SIM
                                @else
                                    NÃO
                                @endif
                    ...
                    <div class="callout callout-info col-md-6 border p-2 text-center">
                        {{-- <img class="img-fluid" src="{{env('APP_URL_GESTOR')}}/{{str_replace('public', 'storage', $usuario->company->imagem)}}" width="500" alt="{{mb_strtoupper($usuario->pessoa->nome)}}" title="{{mb_strtoupper($usuario->pessoa->nome)}}"> --}}
                ...
                <div class="row col-md-12">
                    <div class="mr-2">
                        <a href="{{route('usuarios.index')}}" class="btn btn-outline-secondary"><i class="fas fa-undo"></i> Voltar</a>
                        
                        
                        <a href="{{ route('usuarios.edit', $usuario->id) }}" class="btn btn-outline-success"><i class="fas fa-edit"></i> Editar </a>
